 ...
 *   (pthread), distribuyendo el trabajo entre hilos a partir de la división de filas y midiendo el         *
 *   tiempo total de ejecución con resolución de microsegundos.                                             *
 ************************************************************************************************************
 * HOW TO USE / COMPILAR / EJECUTAR                                                                         *
 *                                                                                                          *
 * Compilación (ejemplo):                                                                                   *
 *   $ gcc -Wall -Wextra -pthread multiMatrix_pthread.c -o multiMatrix_pthread                              *
 *                                                                                                          *
 * USO:                                                                                                     *
 ...
 *   - Tiempo total de ejecución mostrado en segundos (a partir de microsegundos medidos).                  *
 ************************************************************************************************************/
